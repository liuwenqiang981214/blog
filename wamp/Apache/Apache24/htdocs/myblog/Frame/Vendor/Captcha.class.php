...
final class Captcha
{
	...
	//构造方法
	public function __construct($codelen=4,$width=85,$height=25,$fontsize=18)
	{
	...
	private function createFont()
	{
		...
		imagettftext($this->img,$this->fontsize,0,15,20,$this->fontcolor,$this->fontfile,$this->code);
	}
	//输出
